...
Do NOT add the Telegram function yet — Task 2 will add it. For now, reference `sendTelegramNotification` as an undefined function placeholder (or add a stub that logs "Telegram: not yet implemented"). The file must still be syntactically valid.
  </action>
  <verify>
